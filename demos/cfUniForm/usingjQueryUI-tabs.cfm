...
<head>
	...
	<title>cfUniForm Using jQuery UI Tabs Demo</title>
</head>

<body>

<p>
	This page displays the "Using jQuery UI Tabs" demo form.
	View the 
	<a href="usingjQueryUI-tabsCode.cfm">code used to generate the form</a>.
</p>
<p>
	NOTE: cfUniForm includes a couple of default style rules that are designed 
	specifically for use with jQuery UI's tabs.  Should you wish to change 
...
<ul>
	<li><a href="usingjQueryUI-tabsCode.cfm">View the code</a></li>
	<li><a href="index.cfm">Back to the cfUniForm demo home</a></li>
	<li><a href="https://github.com/QuackFuzed/cfUniForm">Download cfUniForm from GitHub</a></li>
	<li><a href="http://www.quackfuzed.com/index.cfm/UniForm-Tag-Library">View my blog</a></li>
</ul>
