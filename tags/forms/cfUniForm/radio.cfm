...
<!--- // use example
	...
	@readOnlyValue			Optional (string) - value to show if form or field is set to read-only																defaults to 'false'
...
<!--- define the tag attributes --->
	...
	<cfparam name="attributes.readOnlyValue" type="string" default="#attributes.label#">
