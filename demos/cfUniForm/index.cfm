...
<head>
	...
	<title>cfUniForm Demos - XHTML Strict Markup for your ColdFusion Forms</title>
</head>

<body>

<h3>cfUniForm - ColdFusion Custom Tag Library</h3>
<p>
	A ColdFusion custom tag library written by 
	<a href="http://www.quackfuzed.com/">Matt Quackenbush</a> used for 
	creating forms that meet the XHTML 1.0 Strict markup standard, 
	based upon the Uni-Form XHTML Markup and CSS by 
...
<h4>cfUniForm In The Wild</h4>
<ul>
	<li>
		Rachel Queen Services Group, LLC
		<ul>
			<li><a href="http://www.rachelqueensg.com/index.cfm/go/contact">contact form</a></li>
		</ul>
	</li>
	<li>
		TheHealthChallenge.com
		<ul>
			<li><a href="http://www.thehealthchallenge.com/index.cfm?x=Register.Form">registration form</a></li>
			<li><a href="http://www.thehealthchallenge.com/index.cfm?x=Login">login form</a></li>
		</ul>
	</li>
	<li>
		National Institute of Standards and Technology
		<ul>
			<li><a href="http://gsi.nist.gov/global/index.cfm/L1-1/A-19">contact form</a></li>
		</ul>
	</li>
	<li>
		ValidateThis!
		<ul>
			<li><a href="http://www.validatethis.org/">demo registration form</a></li>
		</ul>
	</li>
</ul>
...
<ul>
	<li>
		...
		<ul>
			<li><a href="http://www.sprawsm.com/uni-form/">Uni-Form Home</a></li>
			<li><a href="http://github.com/draganbabic/uni-form">Uni-Form @ GitHub</a></li>
		</ul>
	</li>
	<li>
		Integrated <a href="http://jquery.com/">jQuery</a> <a href="http://plugins.jquery.com/">Plugins</a>: 
		<ul>
			<li><a href="http://docs.jquery.com/Plugins/Validation">Form Validation</a></li>
	...
	<li>
		...
		<ul>
			<li><a href="http://validatethis.riaforge.org/">ValidateThis!</a></li>
		</ul>
	</li>
	<li>
		Contributors: 
		<ul>
			...
			<li><a href="http://www.cfwebstore.com/">Mary Jo Sminkey</a></li>
			<li><a href="http://www.backslash.ch/Mischa-Sameli">Mischa Sameli</a></li>
			<li><a href="http://www.think-lab.net/">Matt Graf</a></li>
		</ul>
	</li>
</ul>
